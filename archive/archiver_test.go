...
import (
	...
	"github.com/gotoolkit/std/archive"
...
func TestZipArchive(t *testing.T) {
	...
	err := archive.ZIP.Archive("test/hash1", "test/output/1.zip")
	require.NoError(t, err)

	// unzip
	err = archive.ZIP.Restore("test/output/1.zip", "test/output/restored")
	require.NoError(t, err)
...
var _ archive.Archiver = (*TestArchiver)(nil)
